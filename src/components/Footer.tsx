            ...
            <div className="mx-auto max-w-screen-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        ...
                        <h2></h2>
                        <p className="w-[80%] my-6 text-gray-500">
                            <strong>Garanhuns:</strong> Rua Dr. José Mariano, 341 - Bairro São José
                            <br />
                            CEP: 55295 335
                            <br />
                            Fone e WhatsApp: 87 9.9800-2900
                            <br/>
                            <br/>
                            <strong>Caruaru:</strong> Av. Major Manoel de Freitas, 62 - 1º Andar -  Bairro: Maurício de Nassau
                            <br />
                            CEP: 55012 300
                            <br />
                            Fone e WhatsApp: 81 9.9212-8325
                        </p>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">© 2022 <a href="https://flowbite.com" className="hover:underline">Primeiro Emprego™</a> Todos os direitos reservados.
                    </span>
